                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <form name="formAutorizar" id="formAutorizar" method="POST" action="AutorizarPermiso">
                                                        <td><input readonly size="4" type="text" name="id_permiso" id="id_permiso" value="<%=permiso.getId_permiso()%>"></td>
                                                        ...
                                                        <td><button class="btn btn-link" type="submit">Ver Permiso</button></td>
                                                    </form>
                                                </tr>
                                                <% }  %>
                                            </tbody>
