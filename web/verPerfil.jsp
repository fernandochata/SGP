        ...
        <section class="body-block">
            ...
            <div class="container">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        <td>Direccion:</td>
                        <td><%=usuario.getDireccion() %> - <%=usuario.getComuna() %></td>
                    </tr>
                        <td>Telefono:</td>
                    ...
                    <tr>
                        ...
                        <td><%=Fechas.toStringFecha(usuario.getFecha_contrato()) %></td> 
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center"><a href="Regresar" class="btn btn-primary">Regresar</a></td>
                    </tr>
                    </tbody>
                </table>
                                        <br>
