    ...
    <body>
        <section>
            <%
                ...
                ArrayList<PermisoDTO> decretos = (ArrayList<PermisoDTO>)request.getSession().getAttribute("permisosEstadoDepartamento");
                ArrayList<PermisoDTO> permisos = (ArrayList<PermisoDTO>)request.getSession().getAttribute("permisosDepartamento");
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <form action="VerResolucion">
                                                    <td><button value="<%=permiso.getResolucion()%>" type="submit" name="id_resolucion" class="btn btn-link btn-sm">Ver <%=permiso.getResolucion()%></button></td>
                                                </form>
                                            </tr>
                                            <%}%>
                                        </tbody>
